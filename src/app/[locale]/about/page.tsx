        ...
        <Stack gap="xl">
          ...
          <Stack align="center" ta="center" gap="md">
            ...
            <Stack align="center" ta="center" gap="md">
              ...
              <Title order={2} fw={700}>
                A modern workspace for designing and testing REST APIs
              </Title>

              <Text size="lg" maw={TEXT_WIDTH}>
                Create and edit OpenAPI specifications, explore generated documentation,
                and test API endpoints directly from your browser.
              </Text>
          ...
          >
            <Stack align="center" ta="center" gap="xl">
              ...
              <Text size="lg" maw={TEXT_WIDTH} lh={1.7}>
                ...
                , an educational program focused on modern front-end development.
              </Text>
          ...
          <Stack align="center" gap="md">
            ...
            <Text ta="center" maw={600}>
              Huge thanks to our mentors for their guidance, support, and valuable feedback
